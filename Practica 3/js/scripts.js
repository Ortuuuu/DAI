...
function addCuestionario(evento) {
    ...
    if(tituloCuestionario.value == "") {
        ...
        let encabezadoSeccion = document.createElement("encabezado-cuestionario");
        encabezadoSeccion.setAttribute("data-tema", tituloCuestionario.value);
